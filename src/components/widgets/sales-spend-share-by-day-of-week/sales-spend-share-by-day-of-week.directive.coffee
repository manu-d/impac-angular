...
module.controller('WidgetSalesSpendShareByDayOfWeekCtrl', ($scope, $q, $filter, ImpacWidgetsSvc, ImpacAssets, HighchartsFactory, ImpacUtilities) ->
...
module.directive('widgetSalesSpendShareByDayOfWeek', ->
  return {
    restrict: 'A',
