...
angular.module('impac.components.widgets',
  [
    ...
    'impac.components.widgets.sales-spend-share-by-day-of-week',
    ...
    'impac.components.widgets.sales-transaction-by-time-of-day'
  ]
);
...
$templateCache.put("widgets/sales-average-spend-per-customer.tmpl.html","<div widget-sales-average-spend-per-customer>\n  <!-- Settings Panel -->\n  <div ng-show=\"widget.isEditMode\" class=\"edit\">\n    <h4>Widget settings</h4>\n\n    <div setting-organizations parent-widget=\"widget\" class=\"part\" deferred=\"::orgDeferred\" />\n\n    <!-- Buttons displayed on the lower  -->\n    <div class=\"bottom-buttons\" align=\"right\">\n      <button class=\"btn btn-default\" ng-click=\"initSettings()\">Cancel</button>\n      <button class=\"btn btn-warning\" ng-click=\"updateSettings()\">Save</button>\n    </div>\n  </div>\n\n  <!-- Content Panel -->\n  <div ng-hide=\"widget.isEditMode\">\n    <!-- Data found -->\n    <div ng-show=\"(isDataFound==true)\" class=\"\">\n      <!-- Chart -->\n      <div id=\"{{chartId()}}\" class=\"average-spend-per-customer-chart\"></div>\n\n    </div>\n\n    <!-- No data found -->\n    <div ng-if=\"(isDataFound==false)\" common-data-not-found on-display-alerts=\"onDisplayAlerts()\" endpoint=\"::widget.category\" width=\"::widget.width\" />\n  </div>\n</div>");
...
$templateCache.put("widgets/sales-new-customers.tmpl.html","<div widget-sales-new-customers>\n  <!-- Settings Panel -->\n  <div ng-show=\"widget.isEditMode\" class=\"edit\">\n    <h4>Widget settings</h4>\n\n    <div setting-organizations parent-widget=\"widget\" class=\"part\" deferred=\"::orgDeferred\" />\n\n    <!-- Buttons displayed on the lower  -->\n    <div class=\"bottom-buttons\" align=\"right\">\n      <button class=\"btn btn-default\" ng-click=\"initSettings()\">Cancel</button>\n      <button class=\"btn btn-warning\" ng-click=\"updateSettings()\">Save</button>\n    </div>\n  </div>\n\n  <!-- Content Panel -->\n  <div ng-hide=\"widget.isEditMode\">\n    <!-- Data found -->\n    <div ng-show=\"(isDataFound==true)\" class=\"\">\n      <h6>As at {{latestDate()}}</h6>\n      <div>\n        <div align=\"center\" class=\"options\">\n          <a ng-click=\"toggleHistMode(false)\" ng-class=\"!isHistMode ? \'active\' : \'inactive\'\"> Latest </a> |\n          <a ng-click=\"toggleHistMode(true)\" ng-class=\"isHistMode ? \'active\' : \'inactive\'\" translate>History</a>\n        </div>\n\n        <div class=\"{{isHistMode ? \'arrow-container right\' : \'arrow-container left\'}}\">\n          <div class=\"arrow\" />\n          <div class=\"arrow-border\" />\n        </div>\n      </div>\n\n      <div ng-hide=\"isHistMode\">\n        <impac-figure-layout content=\"widget.content.figure\"/>\n      </div>\n\n      <div ng-show=\"isHistMode\">\n        <div impac-chart draw-trigger=\"drawTrigger.promise\" deferred=\"chartDeferred\"></div>\n        <div class=\"legend\">\n          <span ng-style=\"{ \'color\': getColorByIndex(0) }\">Merchant</span> -\n          <span ng-style=\"{ \'color\': getColorByIndex(1) }\">Competitive Set</span> -\n          <span ng-style=\"{ \'color\': getColorByIndex(2) }\">Industry</span>\n        </div>\n      </div>\n    </div>\n\n    <!-- No data found -->\n    <div ng-if=\"(isDataFound==false)\" common-data-not-found on-display-alerts=\"onDisplayAlerts()\" endpoint=\"::widget.category\" width=\"::widget.width\" />\n  </div>\n</div>");
...
$templateCache.put("widgets/sales-repeat-customers.tmpl.html","<!--\n  Component generated by Impac! Widget Generator!\n-->\n<div widget-sales-repeat-customers>\n  <!-- Settings Panel -->\n  <div ng-show=\"widget.isEditMode\" class=\"edit\">\n    <h4>Widget settings</h4>\n\n    <div setting-organizations parent-widget=\"widget\" class=\"part\" deferred=\"::orgDeferred\" />\n\n    <!-- Buttons displayed on the lower  -->\n    <div class=\"bottom-buttons\" align=\"right\">\n      <button class=\"btn btn-default\" ng-click=\"initSettings()\">Cancel</button>\n      <button class=\"btn btn-warning\" ng-click=\"updateSettings()\">Save</button>\n    </div>\n  </div>\n\n  <!-- Content Panel -->\n  <div ng-hide=\"widget.isEditMode\">\n    <!-- Data found -->\n    <div ng-show=\"(isDataFound==true)\" class=\"\">\n      <div class=\"title\">Percentage of customers at the store with more than one transaction</div>\n      <div>\n        <div align=\"center\" class=\"options\">\n          <a ng-click=\"toggleHistMode(false)\" ng-class=\"!isHistMode ? \'active\' : \'inactive\'\"> Latest </a> |\n          <a ng-click=\"toggleHistMode(true)\" ng-class=\"isHistMode ? \'active\' : \'inactive\'\" translate>History</a>\n        </div>\n\n        <div class=\"{{isHistMode ? \'arrow-container right\' : \'arrow-container left\'}}\">\n          <div class=\"arrow\" />\n          <div class=\"arrow-border\" />\n        </div>\n      </div>\n\n      <div ng-hide=\"isHistMode\">\n        <table>\n          <tr>\n            <td/>\n            <td>Within</td>\n            <td/>\n          </tr>\n          <tr>\n            <td>1 month</td>\n            <td/>\n            <td>2 months</td>\n          </tr>\n          <tr ng-repeat=\"figure in widget.content.figure\">\n            <td ng-style=\"{\'color\': getColorByIndex($index)}\">{{figure.value[0]}}%</td>\n            <td>{{figure.label}}</td>\n            <td ng-style=\"{\'color\': getColorByIndex($index)}\">{{figure.value[1]}}%</td>\n          </tr>\n        </table>\n      </div>\n\n      <div ng-show=\"isHistMode\">\n        <div impac-chart draw-trigger=\"drawTrigger.promise\" deferred=\"chartDeferred\"></div>\n        <div class=\"legend\">\n          <span ng-style=\"{ \'color\': getColorByIndex(0) }\">Merchant</span> -\n          <span ng-style=\"{ \'color\': getColorByIndex(1) }\">Competitive Set</span> -\n          <span ng-style=\"{ \'color\': getColorByIndex(2) }\">Industry</span>\n        </div>\n        <div class=\"legend\">Within 1 month</h6>\n      </div>\n    </div>\n\n    <!-- No data found -->\n    <div ng-if=\"(isDataFound==false)\" common-data-not-found on-display-alerts=\"onDisplayAlerts()\" endpoint=\"::widget.category\" width=\"::widget.width\" />\n  </div>\n</div>");
...
$templateCache.put("widgets/sales-spend-share-by-day-of-week.tmpl.html","<!--\n  Component generated by Impac! Widget Generator!\n-->\n<div widget-sales-spend-share-by-day-of-week>\n  <!-- Settings Panel -->\n  <div ng-show=\"widget.isEditMode\" class=\"edit\">\n    <h4>Widget settings</h4>\n\n    <div setting-organizations parent-widget=\"widget\" class=\"part\" deferred=\"::orgDeferred\" />\n\n    <!-- Buttons displayed on the lower  -->\n    <div class=\"bottom-buttons\" align=\"right\">\n      <button class=\"btn btn-default\" ng-click=\"initSettings()\">Cancel</button>\n      <button class=\"btn btn-warning\" ng-click=\"updateSettings()\">Save</button>\n    </div>\n  </div>\n\n  <!-- Content Panel -->\n  <div ng-hide=\"widget.isEditMode\">\n    <!-- Data found -->\n    <div ng-show=\"isChartDisplayed\" class=\"\">\n      <!-- Chart -->\n      <div id=\"{{chartId()}}\" class=\"customers-engagement-chart\"></div>\n\n    </div>\n\n    <!-- No data found -->\n    <div ng-if=\"(isDataFound==false)\" common-data-not-found on-display-alerts=\"onDisplayAlerts()\" endpoint=\"::widget.category\" width=\"::widget.width\" />\n  </div>\n</div>\n");
...
$templateCache.put("widgets/sales-transaction-by-time-of-day.tmpl.html","<!--\n  Component generated by Impac! Widget Generator!\n-->\n<div widget-sales-transaction-by-time-of-day>\n  <!-- Settings Panel -->\n  <div ng-show=\"widget.isEditMode\" class=\"edit\">\n    <h4>Widget settings</h4>\n\n    <div setting-organizations parent-widget=\"widget\" class=\"part\" deferred=\"::orgDeferred\" />\n\n    <!-- Buttons displayed on the lower  -->\n    <div class=\"bottom-buttons\" align=\"right\">\n      <button class=\"btn btn-default\" ng-click=\"initSettings()\">Cancel</button>\n      <button class=\"btn btn-warning\" ng-click=\"updateSettings()\">Save</button>\n    </div>\n  </div>\n\n  <!-- Content Panel -->\n  <div ng-hide=\"widget.isEditMode\">\n    <!-- Data found -->\n    <div ng-show=\"(isDataFound==true)\" class=\"\">\n      <div id=\"{{chartId()}}\" class=\"transaction-chart\"></div>\n\n    </div>\n\n    <!-- No data found -->\n    <div ng-if=\"(isDataFound==false)\" common-data-not-found on-display-alerts=\"onDisplayAlerts()\" endpoint=\"::widget.category\" width=\"::widget.width\" />\n  </div>\n</div>");
$templateCache.put("widgets-layouts/figure.tmpl.html","<div class=\"layouts figure\">\n  <div ng-repeat=\"figure in content\">\n    <h3>{{figure.label}}</h3>\n    <div class=\"value\" ng-style=\"{\'color\': getColorByIndex($index)}\">{{figure.value}}</div>\n    <div ng-show=\"figure.unit\">{{figure.unit}}></div>\n  </div>\n</div>\n");
...
(function() {
  angular.module('impac.services.highcharts-theme', []).service('HighchartsThemeService', ["ImpacTheming", function(ImpacTheming) {
    Highcharts.theme = {
...
(function() {
  ...
  module.controller('FigureLayoutCtrl', ["$scope", "$translate", "ChartFormatterSvc", function($scope, $translate, ChartFormatterSvc) {
    return $scope.getColorByIndex = function(index) {
      return ChartFormatterSvc.getColor(index);
    };
  }]);

  module.directive('impacFigureLayout', ["$templateCache", function($templateCache) {
    return {
      restrict: 'E',
      scope: {
        content: '=',
...
(function() {
  ...
  module.controller('WidgetSalesAveragePurchaseSizeCtrl', ["$scope", "$q", "$filter", "ImpacWidgetsSvc", "ImpacAssets", "HighchartsFactory", "ImpacUtilities", function($scope, $q, $filter, ImpacWidgetsSvc, ImpacAssets, HighchartsFactory, ImpacUtilities) {
    var dateFilter, onClickBar, settingsPromises, todayUTC, w;
    w = $scope.widget;
...
(function() {
  ...
  module.controller('WidgetSalesAverageSpendPerCustomerCtrl', ["$scope", "$q", "$filter", "ImpacWidgetsSvc", "ImpacAssets", "HighchartsFactory", "ImpacUtilities", function($scope, $q, $filter, ImpacWidgetsSvc, ImpacAssets, HighchartsFactory, ImpacUtilities) {
    ...
    $scope.chartId = function() {
      return "averageSpendPerCustomerChart-" + w.id;
    };
    $scope.chartDeferred = $q.defer();
    w.initContext = function() {
      return $scope.isDataFound = w.content != null;
  ...
  module.directive('widgetSalesAverageSpendPerCustomer', function() {
    return {
      restrict: 'A',
...
(function() {
  ...
  module.controller('WidgetSalesAverageVisitCtrl', ["$scope", "$q", "$filter", "ImpacWidgetsSvc", "ImpacAssets", "HighchartsFactory", "BoltResources", function($scope, $q, $filter, ImpacWidgetsSvc, ImpacAssets, HighchartsFactory, BoltResources) {
    ...
    w.format = function() {
      ...
      $scope.chart = new HighchartsFactory($scope.chartId(), w.content.chart, options);
      $scope.chart.formatters = function() {
        var currency, leftYAxis, rightYAxis, xAxisLabels, yAxisLabels;
        currency = this.options.currency;
        xAxisLabels = {
          labels: {
            formatter: function() {
...
(function() {
  ...
  module.controller('WidgetSalesDaysBetweenVisitsCtrl', ["$scope", "$q", "$filter", "ChartFormatterSvc", function($scope, $q, $filter, ChartFormatterSvc) {
    var settingsPromises, w;
    w = $scope.widget;
    ...
    $scope.toggleHistMode = function(histMode) {
      return $scope.isHistMode = histMode;
    };
    $scope.getColorByIndex = function(index) {
      return ChartFormatterSvc.getColor(index);
    };
    $scope.latestDate = function() {
      var date;
    ...
    $scope.drawTrigger = $q.defer();
    w.format = function() {
      var chartData, dates, lineData, lineOptions;
      if ($scope.isDataFound) {
        dates = _.map(w.content.small_chart.dates, function(date) {
        ...
        lineData = [
          {
            title: 'Merchant',
            labels: dates,
            values: w.content.small_chart.merchant_values
          }, {
            title: 'Competitive Set',
            labels: dates,
            values: w.content.small_chart.competitive_values
          }, {
            title: 'Industry',
            labels: dates,
            values: w.content.small_chart.industry_values
          }
        ];
        chartData = ChartFormatterSvc.lineChart(lineData, lineOptions);
        return $scope.drawTrigger.notify(chartData);
  ...
  module.directive('widgetSalesDaysBetweenVisits', function() {
    return {
      restrict: 'A',
...
(function() {
  ...
  module.controller('WidgetSalesNewCustomersCtrl', ["$scope", "$q", "$filter", "ChartFormatterSvc", function($scope, $q, $filter, ChartFormatterSvc) {
    var settingsPromises, w;
    w = $scope.widget;
    $scope.orgDeferred = $q.defer();
    $scope.chartDeferred = $q.defer();
  ...
  module.directive('widgetSalesNewCustomers', function() {
    return {
      restrict: 'A',
...
(function() {
  ...
  module.controller('WidgetSalesRepeatCustomersCtrl', ["$scope", "$q", "$filter", "ChartFormatterSvc", function($scope, $q, $filter, ChartFormatterSvc) {
    var settingsPromises, w;
    w = $scope.widget;
    $scope.orgDeferred = $q.defer();
    $scope.chartDeferred = $q.defer();
  ...
  module.directive('widgetSalesRepeatCustomers', function() {
    return {
      restrict: 'A',
...
(function() {
  ...
  module = angular.module('impac.components.widgets.sales-spend-share-by-day-of-week', []);

  module.controller('WidgetSalesSpendShareByDayOfWeekCtrl', ["$scope", "$q", "$filter", "ImpacWidgetsSvc", "ImpacAssets", "HighchartsFactory", "ImpacUtilities", function($scope, $q, $filter, ImpacWidgetsSvc, ImpacAssets, HighchartsFactory, ImpacUtilities) {
    var dateFilter, settingsPromises, todayUTC, w;
    w = $scope.widget;
    $scope.isChartDisplayed = true;
    $scope.orgDeferred = $q.defer();
  ...
  module.directive('widgetSalesSpendShareByDayOfWeek', function() {
    return {
      restrict: 'A',
      controller: 'WidgetSalesSpendShareByDayOfWeekCtrl'
    };
  });
...
(function() {
  ...
  module.controller('WidgetSalesTransactionByTimeOfDayCtrl', ["$scope", "$q", "HighchartsFactory", function($scope, $q, HighchartsFactory) {
    var settingsPromises, w;
    w = $scope.widget;
    $scope.isChartDisplayed = true;
    $scope.orgDeferred = $q.defer();
    settingsPromises = [$scope.orgDeferred.promise];
    $scope.chartId = function() {
      return "averageTransactionTimeChart-" + w.id;
    };
    $scope.chartDeferred = $q.defer();
    w.initContext = function() {
      return $scope.isDataFound = w.content != null;
  ...
  module.directive('widgetSalesTransactionByTimeOfDay', function() {
    return {
      restrict: 'A',
